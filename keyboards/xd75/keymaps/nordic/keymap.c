...
#define MO_SPECIAL  MO(_SPECIAL)

#define SFT_PGDN MT(MOD_RSFT, KC_PGDN)
#define SFT_PGUP MT(MOD_RSFT, KC_PGUP)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

/* Qwerty
 * ,--------------------------------------------------------------------------------------------------------.
 * | ESC  |   1  |   2  |   3  |   4  |   5  |   6  |   7  |  8   |   9  |   0  |   +  |   ´  |  del | Bksp |
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | Tab  |   Q  |   W  |   E  |   R  |   T  |   Y  |   U  |  I   |   O  |   P  |   Å  |   ^  |  Ins | Ins  |
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | capsl|   A  |   S  |   D  |   F  |   G  |   H  |   J  |  K   |   L  |   Æ  |   Ø  |   *  |enter |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift|   <  |   Z  |   X  |   C  |   V  |   B  |   N  |  M   |   ,  |   .  |   -  |PgUp/sft|UP|PgDo/sft| 
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Gui  | Alt  | RAISE|Space |Space | Space| Space| LOWER| AltGr| FN1  |RShift| Left | Down |Right |
 * `--------------------------------------------------------------------------------------------------------'
 */

[_QWERTY] = {
	{KC_ESC,  KC_1,    KC_2,    KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,    KC_9,    KC_0,   NO_PLUS,    KC_EQL,  KC_DEL,  KC_BSPC},
	{KC_TAB,  KC_Q,    KC_W,    KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,    KC_O,    KC_P,   NO_AM,      NO_QUOT, KC_INS,  KC_INS},
	{KC_CAPS, KC_A,    KC_S,    KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,    KC_L,    NO_AE,  NO_OSLH,    NO_APOS, KC_ENT,  KC_ENT},
	{KC_LSFT, NO_LESS, KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,    KC_COMM, KC_DOT, NO_MINS,    SFT_PGUP, KC_UP,   SFT_PGDN},
	{KC_LCTL, KC_LGUI, KC_LALT, MO_FN0, KC_SPC, KC_SPC, KC_SPC, KC_SPC, KC_RALT, MO_FN1,  MO_FN2, MO_SPECIAL, KC_LEFT, KC_DOWN, KC_RIGHT}
},
...
[_FN0] = {
	...
	{KC_TAB,  _______, KC_UP,  _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______}, 
